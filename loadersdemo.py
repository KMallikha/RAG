...
document2=TextLoader("C:\\Users\\MallikhaKaparaveni\\OneDrive - Accellor\\Documents\\langchainfile.txt")
...
document4=WebBaseLoader("https://en.wikipedia.org/wiki/Artificial_intelligence")
data4=document4.load()
print(data4[0].page_content[:700])